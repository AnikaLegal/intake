...
export const HAS_CONTACTED_LANDLORD  {
...
export const LANDLORD_CONTACT_METHOD = {
...
export const LANDLORD_CONTACT_DATE = {
...
export const LANDLORD_CONTACT_ATTEMPTS = {
...
export const LANDLORD_CONTACT_RECORDS = {
...
export const LANDLORD_HAS_AGENT = {
...
export const LANDLORD_EMAIL = {
  name: 'LANDLORD_EMAIL',
  type: FIELD_TYPES.TEXT,
  placeholder: 'Email address',
}

export const LANDLORD_PHONE = {
  name: 'LANDLORD_PHONE',
  type: FIELD_TYPES.TEXT,
  placeholder: 'Mobile number',
}

export const IS_VCAT_OK = {
  name: 'IS_VCAT_OK',
...
export const VCAT_AVOID_REASON = {
